 ...
 */
class Media extends \Polytech\EcommerceBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Media' . "\0" . 'updateAt', 'name', 'path', 'file');
        }

        return array('__isInitialized__', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Media' . "\0" . 'updateAt', 'file');
    }
