 ...
 */
class Commandes extends \Polytech\EcommerceBundle\Entity\Commandes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'id', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'entreprise', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'valider', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'status', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'date', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'reference', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'commande');
        }
