...
namespace Proxies\__CG__\Polytech\DepartementBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Departement extends \Polytech\DepartementBundle\Entity\Departement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Polytech\\DepartementBundle\\Entity\\Departement' . "\0" . 'id', '' . "\0" . 'Polytech\\DepartementBundle\\Entity\\Departement' . "\0" . 'numero', '' . "\0" . 'Polytech\\DepartementBundle\\Entity\\Departement' . "\0" . 'nom');
        }
