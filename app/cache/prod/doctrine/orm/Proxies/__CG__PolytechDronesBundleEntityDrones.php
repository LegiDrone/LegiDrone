...
namespace Proxies\__CG__\Polytech\DronesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Drones extends \Polytech\DronesBundle\Entity\Drones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Polytech\\DronesBundle\\Entity\\Drones' . "\0" . 'id', '' . "\0" . 'Polytech\\DronesBundle\\Entity\\Drones' . "\0" . 'entreprise', '' . "\0" . 'Polytech\\DronesBundle\\Entity\\Drones' . "\0" . 'document', '' . "\0" . 'Polytech\\DronesBundle\\Entity\\Drones' . "\0" . 'media', '' . "\0" . 'Polytech\\DronesBundle\\Entity\\Drones' . "\0" . 'name', '' . "\0" . 'Polytech\\DronesBundle\\Entity\\Drones' . "\0" . 'approval');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Drones $proxy) {
