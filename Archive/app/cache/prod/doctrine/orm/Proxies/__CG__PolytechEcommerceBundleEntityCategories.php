 ...
 */
class Categories extends \Polytech\EcommerceBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Categories' . "\0" . 'media', '' . "\0" . 'Polytech\\EcommerceBundle\\Entity\\Categories' . "\0" . 'nom');
        }
