...
class Entreprises extends \Polytech\ProjetCoBundle\Entity\Entreprises implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Polytech\\ProjetCoBundle\\Entity\\Entreprises' . "\0" . 'id', '' . "\0" . 'Polytech\\ProjetCoBundle\\Entity\\Entreprises' . "\0" . 'commandes', '' . "\0" . 'Polytech\\ProjetCoBundle\\Entity\\Entreprises' . "\0" . 'nom');
        }
