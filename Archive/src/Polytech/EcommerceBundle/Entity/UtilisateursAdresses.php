 ...
 * @ORM\Entity(repositoryClass="Polytech\EcommerceBundle\Entity\UtilisateursAdressesRepository")
 */
class UtilisateursAdresses
{
    ...
    private $id;
    /**
     * @ORM\ManyToOne(targetEntity="Polytech\UserBundle\Entity\User", inversedBy="adresses")
     ...
     * Set utilisateur
     *
     * @param \Polytech\UserBundle\Entity\User $utilisateur
     *
     * @return UtilisateursAdresses
     */
    public function setUtilisateur(\Polytech\UserBundle\Entity\User $utilisateur = null)
    {
     ...
     * Get utilisateur
     *
     * @return \Polytech\UserBundle\Entity\User
     */
